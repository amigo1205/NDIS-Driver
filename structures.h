...
#define IOCTL_ADD_IPV4_RULE CTL_CODE(0x00008000,0x801,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_DEL_IPV4_RULE CTL_CODE(0x00008000,0x802,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_ADD_IPV6_RULE CTL_CODE(0x00008000,0x803,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_DEL_IPV6_RULE CTL_CODE(0x00008000,0x804,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_ACTIVATE_FILTER CTL_CODE(0x00008000,0x805,METHOD_BUFFERED,FILE_ANY_ACCESS)
#define IOCTL_DEACTIVATE_FILTER CTL_CODE(0x00008000,0x806,METHOD_BUFFERED,FILE_ANY_ACCESS)
